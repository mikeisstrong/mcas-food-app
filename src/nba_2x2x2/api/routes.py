    ...
    try:
        ...
        def serialize_stats(stats, team):
            ...
            return {
                ...
                "wins": stats.wins,
                "losses": stats.losses,
                "win_pct": round(stats.win_pct, 3) if stats.win_pct is not None else 0,
                "elo_rating": round(stats.elo_rating, 1),
                "ppf_5game": round(stats.ppf_5game, 2) if stats.ppf_5game is not None else None,
                "ppa_5game": round(stats.ppa_5game, 2) if stats.ppa_5game is not None else None,
                "ppf_10game": round(stats.ppf_10game, 2) if stats.ppf_10game is not None else None,
                "ppa_10game": round(stats.ppa_10game, 2) if stats.ppa_10game is not None else None,
                "ppf_20game": round(stats.ppf_20game, 2) if stats.ppf_20game is not None else None,
                "ppa_20game": round(stats.ppa_20game, 2) if stats.ppa_20game is not None else None,
